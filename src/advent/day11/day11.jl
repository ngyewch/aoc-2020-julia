...
@assert part1(readLayout("src/advent/day11/example.txt")) == 37

@show part1(readLayout("src/advent/day11/input.txt"))
benchmark && @btime part1(readLayout("src/advent/day11/input.txt"));
...
benchmark && @btime part2(readLayout("src/advent/day11/input.txt"));
